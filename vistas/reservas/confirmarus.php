<main class="cuerpo_td">
  ...
  <div class="titulo_emp">
    ...
    <p>Usuario actual <?=$mail?></p>
  </div>
  <div>
    <form class="form_confirm" method="post" action="?c=reservaus&a=Guardar&t=<?=$tipo_hbt?>&id=<?=$id_hu?>">
      <div class="conten_form_confirm">
        ...
        <input required name="Estadotxt" type="hidden" value="<?=$estado_us?>">
